      ...
      return [
        {
          ...
          items: [
            ...
            ,{ id: 'wings', label: 'Wings', icon: HeartHandshake, href: '/admin/wings' }
            ,{ id: 'programs', label: 'Programs', icon: Sparkles, href: '/admin/programs' }
            ,{ id: 'events', label: 'Events', icon: Calendar, href: '/admin/events' }
            ,{ id: 'issues', label: 'Issues', icon: FileText, href: '/admin/issues' }
          ]
        },
        {
          title: 'FINANCE & AUDIT',
    ...
    if (user.role === 'coordinator') {
      return [
        { title: 'COORDINATION', items: [
          { id: 'overview', label: 'Coordinator Dashboard', icon: LayoutDashboard, href: '/dashboard' },
          { id: 'programs', label: 'Programs', icon: Sparkles, href: '/admin/programs' },
          { id: 'events', label: 'Events', icon: Calendar, href: '/admin/events' },
          { id: 'issues', label: 'Issues', icon: FileText, href: '/admin/issues' }
        ] }
