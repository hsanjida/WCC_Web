...
export default function AppShell({ children }) {
  ...
  const publicPaths = ['/wings', '/programs', '/events', '/vision-mission', '/report-issue', '/track-issue'];
  const isGuestSite = pathname === '/' || publicPaths.some((path) => pathname === path || pathname.startsWith(`${path}/`));
